              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  <p>
                    ...
                    knowledge. Thank you for using the app, ${this.state.userInfo.name}! If you want you can add me on Facebook (Le Trung Tuan Anh) and give me feedback on the app. I would love to hear from you!`}
                  </p>
                  <a
